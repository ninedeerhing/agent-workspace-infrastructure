...
Convert slides to images, then have subagent inspect for:
- Overlapping elements, text overflow or cut off
- Elements too close, uneven gaps, insufficient margins
- Low-contrast text/icons, leftover placeholder content
