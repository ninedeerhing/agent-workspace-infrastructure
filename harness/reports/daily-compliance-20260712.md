# Daily Compliance Report - 20260712

- **Checked at**: 2026-07-12 20:00:45
...
- Checked at: 2026-07-12T20:00:44+08:00
- Project: E:\raindeer
- Checks: 106
- Findings: 4
...
| loop-state next action | PASS | d-ml-feature-label-training-executor-loop925 |
| base compliance-check | PASS | findings=4 |

## Findings
| Severity | Code | Title | Detail | Recommendation |
|---|---|---|---|---|
| warning | BASE-SYNC-001 | sync-coherence-index stale | last_lifecycle.at=07/11/2026 12:01:04 exceeds 24h. | python harness/sync_coherence_lifecycle.py run --apply |
| warning | BASE-VER-001 | verification-snapshot-index stale | last_lifecycle.at=07/11/2026 12:01:04 exceeds 24h. | python harness/verification_snapshot_lifecycle.py run --apply |
| warning | BASE-CLO-001 | closure-gate-index stale | last_lifecycle.at=07/11/2026 12:01:04 exceeds 24h. | python harness/closure_gate_lifecycle.py run --apply |
...
| loop-state next action | PASS | D_ML_LIVE_PRODUCT_INTEGRATION_LOOP926：在真实 D 类 UI job 的显式运行确认后，从 existing qa-pg-a |
| methodology-memory-index | PASS | E:\raindeer\harness\methodology-memory-index.json |
| MEM-004 last_lifecycle freshness | PASS | at=07/12/2026 03:10:28 age=16.8380002973333h |
...
| SYNC-001 freshness | WARN | age=31.9946893219167h dirty=False |
| verification-snapshot-index | PASS | E:\raindeer\harness\verification-snapshot-index.json |
| VER-001 freshness | WARN | age=31.9947137056667h dirty=False |
| closure-gate-index | PASS | E:\raindeer\harness\closure-gate-index.json |
| CLO-001 freshness | WARN | age=31.9947389413889h dirty=False |
...
| Severity | Code | Title | Detail | Recommendation |
|----------|------|-------|--------|----------------|
| warning | SYNC-001 | sync-coherence-index stale | last_lifecycle.at=07/11/2026 12:01:04 exceeds 24h. | python harness/sync_coherence_lifecycle.py run --apply |
| warning | VER-001 | verification-snapshot-index stale | last_lifecycle.at=07/11/2026 12:01:04 exceeds 24h. | python harness/verification_snapshot_lifecycle.py run --apply |
| warning | CLO-001 | closure-gate-index stale | last_lifecycle.at=07/11/2026 12:01:04 exceeds 24h. | python harness/closure_gate_lifecycle.py run --apply |
...
```text
{
  "stopped": false,
  "stop_detail": "",
  "next_atomic_action": "D_ML_LIVE_PRODUCT_INTEGRATION_LOOP926������ʵ D �� UI job ����ʽ����ȷ�Ϻ󣬴� existing qa-pg-alt ����ʱ�㰲ȫ feature/forward-return panel������ deterministic trainer������ model lineage/read-model������ verified model ref ������� Factor DSL ��ѡ���� existing live small-batch materialization/scoring��ʧ����������룬���Զ� accepted/backtest��",
  "next_after": "Run a real D-class browser job through scoring and review, then continue A/E source onboarding or formal review readiness based on remaining runtime gaps.",
  "updated_at": "2026-07-12T12:05:00+08:00",
  "last_tick": "SYNC-939-d-ml-training-executor-loop925",
  "last_lifecycle_run": {
    "at": "2026-07-12T03:10:28Z",
    "apply": true,
    "dedupe_actions": 0,
    "dream_candidates": 0,
    "closure_candidates": 0,
    "archived_rounds": [],
    "active_step_digests": 44,
    "completed_tasks_hint": [
      ...
      "d-ml-feature-label-training-executor-loop925",
      "SYNC-939-d-ml-training-executor-loop925"
    ],
    "ttl_days": 180
  },
  "lifecycle_runs": {
...
| sync_coherence | 0 | {
  "apply": true,
  "finding_count": 4,
  "latest_section5": "1262",
  "top_section5_ref": "1262",
  "findings": [... |
| verification_snapshot | 0 | {
  "apply": true,
  "stale": true,
  "git_dirty": true,
  "age_hours": 28.59265492416667,
  "findings": [
    {
... |
| closure_gate | 0 | {
...
| Index | Summary |
|-------|---------|
| methodology-memory-index | last_lifecycle.at=07/12/2026 12:00:45 |
| work-reports-index | last_lifecycle.at=07/12/2026 12:00:45 |
| sync-coherence-index | last_lifecycle.at=07/12/2026 12:00:45 | findings_warn=2 findings_error=0 |
| verification-snapshot-index | last_lifecycle.at=07/12/2026 12:00:45 | findings_warn=1 findings_error=0 |
| closure-gate-index | open_count=0 | last_lifecycle.at=07/12/2026 12:00:45 | findings_warn=0 findings_error=0 |

## Git status (dual repos)

### Raindeer root

- branch=main ahead=62 behind=0 dirty=5
- status -sb:
```text
## main...origin/raindeer-AWI [ahead 62]
...
- branch=main ahead=56 behind=0 dirty=0
- status -sb:
```text
...
- Summary: **degraded_count=5 | env_count=1 | blocker_count=0 | future_count=4**
