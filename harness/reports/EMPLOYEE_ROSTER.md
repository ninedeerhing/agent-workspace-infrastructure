...
|---|---|---|---|---|---|---|---|---|---:|---:|---|---|---|---|---|
| orchestrator | manager:orchestrator | Orchestrator | User-facing coordinator, dispatch, synthesis, verification ownership, truth-source sync | `harness/reports/orchestrator/latest.md` | active | 1 light | high | loop210 coordinated fail-closed manual authorization artifact worker cluster and truth sync | 0 | 9 | 2026-06-22T21:01:21+08:00 | 2026-06-22T21:01:21+08:00 | loop210 done; next explicit injected-runner call boundary / rollback-observability contract | CodeX automations ACTIVE; current verifier thread `019eeed2-dbc0-7313-8d64-f9c6f199c68b`; governance-coordinator `019eeea7-6dc1-7121-8734-2e41c6e21b54`; researcher `019eeebf-629e-7013-bbf4-1db4d312b925`; architect `019eeebf-b3a3-7ab3-bfe8-5a9c4b8b2936`; loop210 test-engineer/executor/code-reviewer/verifier threads recorded; daily_bar/daily_trade_status/adj_factor complete to 2026-06-18; next slice must define call boundary / rollback-observability contract without enabling real/default runner or PL-H execution | Orchestrator must not self-own broad implementation/test/review/governance work; run Goal/Plan + Skill Routing + Worker Dispatch + Worker Cluster/Rendezvous gates before execution; escalate destructive ops, secret exposure, new worker/skill creation, schema migration, real runner call implementation, PL-H execution, or unresolved approval/runner/eligibility gaps |
...
| code-reviewer | worker:code-reviewer | Code Reviewer | Logic defects, maintainability, performance, style review | `harness/reports/workers/code-reviewer.md` | idle | 0 idle | normal | loop210 fail-closed manual authorization artifact final semantic review pass | 0 | 8 | 2026-06-22T21:01:21+08:00 | 2026-06-22T21:01:21+08:00 | - | Cross-dialogue thread `019eeed1-7e14-7342-9d45-d7948aec94d2`; verified manual authorization artifact stays artifact-only/plan-only, evidence-bound to body/submitted/refreshed surfaces, and does not imply authorization granted, runner enablement, or PL-H eligibility | Avoid assigning implementation ownership; for gate reviews verify evidence anchors and separate artifact/preflight blockers from execution enablement |
...
| executor | worker:executor | Executor | Bounded implementation and refactoring under plan constraints | `harness/reports/workers/executor.md` | idle | 0 idle | normal | loop210 implementation scope review pass; shared fixture patch serialized by orchestrator | 1 | 9 | 2026-06-22T21:01:21+08:00 | 2026-06-22T21:01:21+08:00 | - | Cross-dialogue thread `019eeece-c617-71c3-a80a-39a693ad3ac3`; confirmed loop210 should remain tests/fixture-only and JobsPage untouched until a later explicit call-boundary gate | Do not restart `daily_trade_status` or touch `.env.local`; bind artifact/call-boundary/gate markers to source/UI evidence before claiming readiness or execution permission |
...
| test-engineer | worker:test-engineer | Test Engineer | TDD, test design, coverage, stability | `harness/reports/workers/test-engineer.md` | idle | 0 idle | normal | loop210 fail-closed manual authorization artifact RED design pass | 0 | 8 | 2026-06-22T21:01:21+08:00 | 2026-06-22T21:01:21+08:00 | - | Cross-dialogue thread `019eeece-52d7-7b73-868a-7beb496ba303`; required RED contract for manual authorization artifact, injected-runner-only artifact, disabled default runner wiring, rollback/audit hooks, missing-runner fail-closed behavior, PL-H non-eligibility guard, and no-new-checklist-family guard | Avoid brittle string-only tests; require source/UI/runtime evidence anchors plus stale active marker scans for artifact/readiness/gate claims |
