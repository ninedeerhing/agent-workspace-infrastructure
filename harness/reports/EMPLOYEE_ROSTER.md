...
|---|---|---|---|---|---|---|---|---|---:|---:|---|---|---|---|---|
| orchestrator | manager:orchestrator | Orchestrator | User-facing coordinator, dispatch, synthesis, verification ownership, truth-source sync | `harness/reports/orchestrator/latest.md` | active | 1 light | high | loop217 coordinated real-runner adapter preflight gate worker cluster and truth sync | 0 | 15 | 2026-06-23T01:48:12+08:00 | 2026-06-23T01:48:12+08:00 | loop217 done; next adapter invocation/dry-run harness contract | CodeX automations ACTIVE; current verifier thread `019eeed2-dbc0-7313-8d64-f9c6f199c68b`; governance-coordinator `019eeea7-6dc1-7121-8734-2e41c6e21b54`; researcher `019eeebf-629e-7013-bbf4-1db4d312b925`; architect `019eeebf-b3a3-7ab3-bfe8-5a9c4b8b2936`; loop217 test-engineer/executor/code-reviewer/verifier threads recorded; daily_bar/daily_trade_status/adj_factor complete to 2026-06-18; next slice must use loop217 preflight gate for adapter invocation/dry-run harness contract without execution enablement | Orchestrator must not self-own broad implementation/test/review/governance work; run Goal/Plan + Skill Routing + Worker Dispatch + Worker Cluster/Rendezvous gates before execution; escalate destructive ops, secret exposure, new worker/skill creation, schema migration, real runner call implementation, PL-H execution, or unresolved approval/runner/eligibility gaps |
...
| code-reviewer | worker:code-reviewer | Code Reviewer | Logic defects, maintainability, performance, style review | `harness/reports/workers/code-reviewer.md` | idle | 0 idle | normal | loop217 real-runner adapter preflight gate final semantic review pass | 0 | 15 | 2026-06-23T01:48:12+08:00 | 2026-06-23T01:48:12+08:00 | - | Cross-dialogue thread `019eeed1-7e14-7342-9d45-d7948aec94d2`; verified preflight gate stays prerequisite/blocker proof, evidence-bound to body/submitted/refreshed surfaces, and does not imply authorization grant, runner connection, adapter invocation, dry-run execution, runner enablement, or PL-H eligibility | Avoid assigning implementation ownership; for gate reviews verify evidence anchors and separate artifact/preflight/call-boundary/seam/dry-run/proof blockers from execution enablement; flag oversized fixture growth |
...
| executor | worker:executor | Executor | Bounded implementation and refactoring under plan constraints | `harness/reports/workers/executor.md` | idle | 0 idle | normal | loop217 preflight gate implementation scope review pass; shared fixture/module patch serialized by orchestrator | 1 | 16 | 2026-06-23T01:48:12+08:00 | 2026-06-23T01:48:12+08:00 | - | Cross-dialogue thread `019eeece-c617-71c3-a80a-39a693ad3ac3`; confirmed loop217 should remain pure preflight modules plus fixture import/call wiring, JobsPage/runtime runner untouched, and next slice should use preflight gate for adapter invocation/dry-run harness contract | Do not restart `daily_trade_status` or touch `.env.local`; bind artifact/call-boundary/seam/gate/dry-run/proof markers to source/UI evidence before claiming readiness or execution permission |
...
| test-engineer | worker:test-engineer | Test Engineer | TDD, test design, coverage, stability | `harness/reports/workers/test-engineer.md` | idle | 0 idle | normal | loop217 real-runner adapter preflight gate RED design pass | 0 | 15 | 2026-06-23T01:48:12+08:00 | 2026-06-23T01:48:12+08:00 | - | Cross-dialogue thread `019eeece-52d7-7b73-868a-7beb496ba303`; required RED contract for preflight exports/import wiring, exact markers, forbidden family names, and negative execution guards | Avoid brittle string-only tests; require source/UI/runtime evidence anchors plus stale active marker scans for artifact/readiness/gate/call-boundary/seam/dry-run/proof claims |
