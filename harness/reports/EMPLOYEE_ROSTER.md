...
| code-reviewer | worker:code-reviewer | Code Reviewer | Logic defects, maintainability, performance, style review | `harness/reports/workers/code-reviewer.md` | idle | 0 idle | normal | loop219 mocked dry-run proof final semantic review pass | 0 | 17 | 2026-06-23T02:32:13+08:00 | 2026-06-23T02:32:13+08:00 | - | Cross-dialogue thread `019eeed1-7e14-7342-9d45-d7948aec94d2`; verified mocked dry-run proof stays proof-only, evidence-bound to body/submitted/refreshed surfaces, and does not imply authorization grant, runner/config connection, adapter invocation, dry-run execution, or PL-H eligibility | Avoid assigning implementation ownership; for gate reviews verify evidence anchors and separate artifact/preflight/call-boundary/seam/dry-run/proof blockers from execution enablement; flag oversized fixture growth |
...
| executor | worker:executor | Executor | Bounded implementation and refactoring under plan constraints | `harness/reports/workers/executor.md` | idle | 0 idle | normal | loop219 mocked dry-run proof scope review pass; shared fixture/module patch serialized by orchestrator | 1 | 18 | 2026-06-23T02:32:13+08:00 | 2026-06-23T02:32:13+08:00 | - | Cross-dialogue thread `019eeece-c617-71c3-a80a-39a693ad3ac3`; confirmed loop219 should remain bounded mocked dry-run modules plus fixture import/call wiring, JobsPage/runtime runner untouched, and next slice should use mocked dry-run proof gate for authorization packet/preflight | Do not restart `daily_trade_status` or touch `.env.local`; bind artifact/call-boundary/seam/gate/dry-run/proof markers to source/UI evidence before claiming readiness or execution permission |
...
| test-engineer | worker:test-engineer | Test Engineer | TDD, test design, coverage, stability | `harness/reports/workers/test-engineer.md` | idle | 0 idle | normal | loop219 mocked dry-run proof RED design pass | 0 | 17 | 2026-06-23T02:32:13+08:00 | 2026-06-23T02:32:13+08:00 | - | Cross-dialogue thread `019eeece-52d7-7b73-868a-7beb496ba303`; required RED contract for mocked dry-run proof exports/import wiring, exact markers, forbidden family names, and negative execution guards | Avoid brittle string-only tests; require source/UI/runtime evidence anchors plus stale active marker scans for artifact/readiness/gate/call-boundary/seam/dry-run/proof claims |
