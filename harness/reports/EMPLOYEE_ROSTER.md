...
| code-reviewer | worker:code-reviewer | Code Reviewer | Logic defects, maintainability, performance, style review | `harness/reports/workers/code-reviewer.md` | idle | 0 idle | normal | loop223 operator handoff readiness final semantic review pass | 0 | 21 | 2026-06-23T04:14:03+08:00 | 2026-06-23T04:14:03+08:00 | - | Cross-dialogue thread `019eeed1-7e14-7342-9d45-d7948aec94d2`; verified handoff readiness gate stays handoff-readiness-only/not-execution, evidence-bound to body/submitted/refreshed surfaces, and does not imply auth/operator approval grant, config connection, runner/adapter invocation, dry-run execution, execution readiness, PL-H eligibility/execution, or secret output | Avoid assigning implementation ownership; for gate reviews verify evidence anchors and separate artifact/preflight/call-boundary/seam/dry-run/proof/handoff blockers from execution enablement; flag oversized fixture growth |
...
| executor | worker:executor | Executor | Bounded implementation and refactoring under plan constraints | `harness/reports/workers/executor.md` | idle | 0 idle | normal | loop223 operator handoff readiness scope review pass; shared fixture/module patch serialized by orchestrator | 1 | 22 | 2026-06-23T04:14:03+08:00 | 2026-06-23T04:14:03+08:00 | - | Cross-dialogue thread `019eeece-c617-71c3-a80a-39a693ad3ac3`; confirmed loop223 should remain bounded operator handoff readiness modules plus fixture import/call wiring, JobsPage/runtime runner untouched, and next slice should use handoff readiness gate for authorized runner handoff execution readiness review | Do not restart `daily_trade_status` or touch `.env.local`; bind artifact/call-boundary/seam/gate/dry-run/proof/handoff markers to source/UI evidence before claiming readiness or execution permission |
...
| test-engineer | worker:test-engineer | Test Engineer | TDD, test design, coverage, stability | `harness/reports/workers/test-engineer.md` | idle | 0 idle | normal | loop223 operator handoff readiness RED contract pass | 0 | 21 | 2026-06-23T04:14:03+08:00 | 2026-06-23T04:14:03+08:00 | - | Cross-dialogue thread `019eeece-52d7-7b73-868a-7beb496ba303`; required RED contract for handoff readiness exports/import wiring, exact markers, forbidden family names, and negative grant/connection/invocation/execution guards | Avoid brittle string-only tests; require source/UI/runtime evidence anchors plus stale active marker scans for artifact/readiness/gate/call-boundary/seam/dry-run/proof/handoff claims |
...
| verifier | worker:verifier | Verifier | Acceptance evidence, final quality gate, residual risk | `harness/reports/workers/verifier.md` | idle | 0 idle | normal | loop223 final verification pass; clean-worktree delegated to orchestrator sync/commit gate | 0 | 22 | 2026-06-23T04:14:03+08:00 | 2026-06-23T04:14:03+08:00 | - | Current cross-dialogue thread `019eeed2-dbc0-7313-8d64-f9c6f199c68b`; old thread `019ee9fe-7605-7d53-8380-57228c31048c` not used for current ticks | Verify focused pytest/smoke/build output, family marker scans, active enablement scans, secret marker scans, runtime cleanup, LOC risk, and residual risk; real runner/PL-H/DB-backed execution remains deferred |
