...
|---|---|---|---|---|---|---|---|---|---:|---:|---|---|---|---|---|
| orchestrator | manager:orchestrator | Orchestrator | User-facing coordinator, dispatch, synthesis, verification ownership, truth-source sync | `harness/reports/orchestrator/latest.md` | active | 1 light | high | coordinating | 0 | 0 | 2026-06-22T17:09:45+08:00 | 2026-06-22T17:09:45+08:00 | loop201 completed PL-G route-evidence acceptance operator handoff packet mocked-only; next PL-G route-evidence acceptance reviewer signoff checklist mocked-only | CodeX automations ACTIVE; verifier thread created; daily_bar/daily_trade_status/adj_factor complete to 2026-06-18; route_evidence chain is closed through chat technical details, Jobs observability, JobsPage fixture, cross-surface source-contract, trigger-response success feedback, refreshed completed Jobs list post-trigger consistency, acceptance-chain summary, readiness-gate summary, acceptance-readiness checklist, operator acceptance banner, acceptance source map, acceptance evidence ledger, acceptance risk register, acceptance mitigation plan, and acceptance operator handoff packet; next slice is acceptance reviewer signoff checklist; do not restart backfill or run migration/background process/default real DB-backed backtest/real runner/PL-H batch execution; keep secret output forbidden | Escalate destructive ops, duplicate process risk, secret exposure, missing runtime secrets, new worker/skill creation, schema migration requests, real runner wiring requests, PL-H execution requests, or unresolved route-evidence acceptance reviewer signoff gaps if they become current scope |
