...
|---|---|---|---|---|---|---|---|---|---:|---:|---|---|---|---|---|
| orchestrator | manager:orchestrator | Orchestrator | User-facing coordinator, dispatch, synthesis, verification ownership, truth-source sync | `harness/reports/orchestrator/latest.md` | active | 1 light | high | loop204 coordinated route guidance transition worker cluster and truth sync | 0 | 3 | 2026-06-22T18:42:50+08:00 | 2026-06-22T18:42:50+08:00 | loop204 done; next intent-quant auto-backtest readiness handoff | CodeX automations ACTIVE; current verifier thread `019eeed2-dbc0-7313-8d64-f9c6f199c68b`; governance-coordinator `019eeea7-6dc1-7121-8734-2e41c6e21b54`; researcher `019eeebf-629e-7013-bbf4-1db4d312b925`; architect `019eeebf-b3a3-7ab3-bfe8-5a9c4b8b2936`; loop204 test-engineer/executor/code-reviewer/verifier threads recorded; daily_bar/daily_trade_status/adj_factor complete to 2026-06-18; next slice must connect intent-quant readiness handoff, not add acceptance checklist family | Orchestrator must not self-own broad implementation/test/review/governance work; run Goal/Plan + Skill Routing + Worker Dispatch + Worker Cluster/Rendezvous gates before execution; escalate destructive ops, secret exposure, new worker/skill creation, schema migration, real runner wiring, PL-H execution, or unresolved readiness handoff gaps |
...
| code-reviewer | worker:code-reviewer | Code Reviewer | Logic defects, maintainability, performance, style review | `harness/reports/workers/code-reviewer.md` | idle | 0 idle | normal | loop204 route transition semantic review pass | 0 | 2 | 2026-06-22T18:31:00+08:00 | 2026-06-22T18:37:00+08:00 | - | Cross-dialogue thread `019eeed1-7e14-7342-9d45-d7948aec94d2`; verified old `pl_g_flow_hardening` is only previous_route and new active next routes bind source/UI evidence | Avoid assigning implementation ownership; for route transitions verify stale active markers are absent and decision markers bind to evidence anchors |
...
| executor | worker:executor | Executor | Bounded implementation and refactoring under plan constraints | `harness/reports/workers/executor.md` | idle | 0 idle | normal | loop204 TDD implementation pass | 1 | 3 | 2026-06-22T18:29:00+08:00 | 2026-06-22T18:35:00+08:00 | - | Cross-dialogue thread `019eeece-c617-71c3-a80a-39a693ad3ac3`; implemented route guidance transition in tests, JobsPage, and smoke fixture with no stale active route marker | Do not restart `daily_trade_status` or touch `.env.local`; bind decision/exit/route markers to source/UI evidence before claiming acceptance |
...
| test-engineer | worker:test-engineer | Test Engineer | TDD, test design, coverage, stability | `harness/reports/workers/test-engineer.md` | idle | 0 idle | normal | loop204 route transition test design pass | 0 | 2 | 2026-06-22T18:28:00+08:00 | 2026-06-22T18:33:00+08:00 | - | Cross-dialogue thread `019eeece-52d7-7b73-868a-7beb496ba303`; required RED contract for route guidance previous/current split and no-new-acceptance-family guard | Avoid brittle string-only tests; require source/UI evidence anchors plus stale active marker scans for decision claims |
