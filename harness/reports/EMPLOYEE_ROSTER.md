...
|---|---|---|---|---|---|---|---|---|---:|---:|---|---|---|---|---|
| orchestrator | manager:orchestrator | Orchestrator | User-facing coordinator, dispatch, synthesis, verification ownership, truth-source sync | `harness/reports/orchestrator/latest.md` | active | 1 light | high | loop211 coordinated call-boundary / rollback-observability worker cluster and truth sync | 0 | 10 | 2026-06-22T21:21:54+08:00 | 2026-06-22T21:21:54+08:00 | loop211 done; next explicit authorized runner injection test seam / PL-H eligibility re-evaluation | CodeX automations ACTIVE; current verifier thread `019eeed2-dbc0-7313-8d64-f9c6f199c68b`; governance-coordinator `019eeea7-6dc1-7121-8734-2e41c6e21b54`; researcher `019eeebf-629e-7013-bbf4-1db4d312b925`; architect `019eeebf-b3a3-7ab3-bfe8-5a9c4b8b2936`; loop211 test-engineer/executor/code-reviewer/verifier threads recorded; daily_bar/daily_trade_status/adj_factor complete to 2026-06-18; next slice must define authorized runner injection seam / PL-H eligibility recheck without enabling real/default runner or PL-H execution | Orchestrator must not self-own broad implementation/test/review/governance work; run Goal/Plan + Skill Routing + Worker Dispatch + Worker Cluster/Rendezvous gates before execution; escalate destructive ops, secret exposure, new worker/skill creation, schema migration, real runner call implementation, PL-H execution, or unresolved approval/runner/eligibility gaps |
...
| code-reviewer | worker:code-reviewer | Code Reviewer | Logic defects, maintainability, performance, style review | `harness/reports/workers/code-reviewer.md` | idle | 0 idle | normal | loop211 call-boundary / rollback-observability final semantic review pass | 0 | 9 | 2026-06-22T21:21:54+08:00 | 2026-06-22T21:21:54+08:00 | - | Cross-dialogue thread `019eeed1-7e14-7342-9d45-d7948aec94d2`; verified call boundary stays contract/evidence-only, evidence-bound to manual artifact plus body/submitted/refreshed surfaces, and does not imply authorization granted, runner enablement, runner invocation, or PL-H eligibility | Avoid assigning implementation ownership; for gate reviews verify evidence anchors and separate artifact/preflight/call-boundary blockers from execution enablement |
...
| executor | worker:executor | Executor | Bounded implementation and refactoring under plan constraints | `harness/reports/workers/executor.md` | idle | 0 idle | normal | loop211 implementation scope review pass; shared fixture patch serialized by orchestrator | 1 | 10 | 2026-06-22T21:21:54+08:00 | 2026-06-22T21:21:54+08:00 | - | Cross-dialogue thread `019eeece-c617-71c3-a80a-39a693ad3ac3`; confirmed loop211 should remain tests/fixture-only and JobsPage untouched until a later authorized runner injection seam gate | Do not restart `daily_trade_status` or touch `.env.local`; bind artifact/call-boundary/gate markers to source/UI evidence before claiming readiness or execution permission |
...
| test-engineer | worker:test-engineer | Test Engineer | TDD, test design, coverage, stability | `harness/reports/workers/test-engineer.md` | idle | 0 idle | normal | loop211 call-boundary / rollback-observability RED design pass | 0 | 9 | 2026-06-22T21:21:54+08:00 | 2026-06-22T21:21:54+08:00 | - | Cross-dialogue thread `019eeece-52d7-7b73-868a-7beb496ba303`; required RED contract for call boundary, explicit authorization handoff, rollback observability before call, audit before/after, missing-runner fail-closed behavior, PL-H non-eligibility recheck, and no-new-checklist-family guard | Avoid brittle string-only tests; require source/UI/runtime evidence anchors plus stale active marker scans for artifact/readiness/gate/call-boundary claims |
...
| verifier | worker:verifier | Verifier | Acceptance evidence, final quality gate, residual risk | `harness/reports/workers/verifier.md` | idle | 0 idle | normal | loop211 final verification pass; clean-worktree delegated to orchestrator sync/commit gate | 0 | 10 | 2026-06-22T21:21:54+08:00 | 2026-06-22T21:21:54+08:00 | - | Current cross-dialogue thread `019eeed2-dbc0-7313-8d64-f9c6f199c68b`; old thread `019ee9fe-7605-7d53-8380-57228c31048c` not used for current ticks | Verify focused pytest/smoke/build output, stale/family marker scans, safety scans, runtime cleanup, and residual risk; real runner/PL-H/DB-backed execution remains deferred |
