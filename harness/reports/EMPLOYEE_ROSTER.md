...
| code-reviewer | worker:code-reviewer | Code Reviewer | Logic defects, maintainability, performance, style review | `harness/reports/workers/code-reviewer.md` | idle | 0 idle | normal | loop225 planning review final semantic review pass | 0 | 23 | 2026-06-23T05:00:00+08:00 | 2026-06-23T05:00:00+08:00 | - | Cross-dialogue thread `019eeed1-7e14-7342-9d45-d7948aec94d2`; verified planning review gate stays planning-review-only/not-execution and does not imply auth/operator approval grant, config connection, runner/adapter invocation, dry-run execution, PL-H eligibility/execution, or secret output | Avoid assigning implementation ownership; for gate reviews verify evidence anchors and separate artifact/preflight/call-boundary/seam/dry-run/proof/handoff blockers from execution enablement; flag oversized fixture growth |
...
| executor | worker:executor | Executor | Bounded implementation and refactoring under plan constraints | `harness/reports/workers/executor.md` | idle | 0 idle | normal | loop225 planning review scope review pass; shared fixture/module patch serialized by orchestrator | 1 | 24 | 2026-06-23T05:00:00+08:00 | 2026-06-23T05:00:00+08:00 | - | Cross-dialogue thread `019eeece-c617-71c3-a80a-39a693ad3ac3`; confirmed loop225 should remain bounded planning review modules plus fixture import/call wiring, JobsPage/runtime runner untouched, and next slice should use planning review gate for explicit controlled runner handoff gate review | Do not restart `daily_trade_status` or touch `.env.local`; bind artifact/call-boundary/seam/gate/dry-run/proof/handoff markers to source/UI evidence before claiming readiness or execution permission |
...
| test-engineer | worker:test-engineer | Test Engineer | TDD, test design, coverage, stability | `harness/reports/workers/test-engineer.md` | idle | 0 idle | normal | loop225 planning review RED contract pass | 0 | 23 | 2026-06-23T05:00:00+08:00 | 2026-06-23T05:00:00+08:00 | - | Cross-dialogue thread `019eeece-52d7-7b73-868a-7beb496ba303`; required RED contract for planning review exports/import wiring, exact markers, forbidden family names, and negative grant/connection/invocation/execution guards | Avoid brittle string-only tests; require source/UI/runtime evidence anchors plus stale active marker scans for artifact/readiness/gate/call-boundary/seam/dry-run/proof/handoff claims |
