...
|---|---|---|---|---|---|---|---|---|---:|---:|---|---|---|---|---|
| orchestrator | manager:orchestrator | Orchestrator | User-facing coordinator, dispatch, synthesis, verification ownership, truth-source sync | `harness/reports/orchestrator/latest.md` | active | 1 light | high | coordinating | 0 | 1 | 2026-06-22T17:37:15+08:00 | 2026-06-22T17:37:15+08:00 | loop-governance-20260622 skill/worker/goal gate repair; next PL-G route-evidence acceptance consolidation bundle | CodeX automations ACTIVE; verifier thread `019ee9fe-7605-7d53-8380-57228c31048c`; governance-coordinator thread `019eeea7-6dc1-7121-8734-2e41c6e21b54`; daily_bar/daily_trade_status/adj_factor complete to 2026-06-18; PL-G route_evidence acceptance chain must consolidate into goal_bundle before any further marker/checklist micro-slice | Orchestrator must not self-own broad implementation/test/review/governance work; run Goal/Plan + Skill Routing + Worker Dispatch gates before execution; escalate destructive ops, secret exposure, new worker/skill creation, schema migration, real runner wiring, PL-H execution, or unresolved consolidation gaps |
